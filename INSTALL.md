# Cuttlefish Installation Guide

For a quick one-command install see the [Quick install](#quick-install) section below, or the [main README](README.md).

## Table of contents

- [Requirements](#requirements)
- [Quick install with the interactive installer](#quick-install-with-the-interactive-installer)
- [Quick start (Docker Compose)](#quick-start-docker-compose)
- [Deploying the master](#deploying-the-master)
- [Deploying a slave](#deploying-a-slave)
- [Limiting test file sizes](#limiting-test-file-sizes)
...
Because the installer asks questions, it reads prompts from `/dev/tty` so it can still be used through `curl | bash`.
...
>
> Also map port `5201` and set `IPERF_PORT="5201"` if you want the iPerf3 commands to work.
